...
import static com.github.ucluster.feature.password.authentication.junit.ResourceReader.read;
...
public class UClusterFeatureTestRunner extends InjectorBasedRunner {
    public UClusterFeatureTestRunner(final Class<?> clazz) throws InitializationError {
        super(clazz);
    }
